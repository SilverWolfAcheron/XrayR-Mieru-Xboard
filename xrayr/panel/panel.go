...
import (
	...
	mieruservice "github.com/XrayR-project/XrayR/service/mieru"
)
...
func (p *Panel) Start() {
	...
	for _, nodeConfig := range p.panelConfig.NodesConfig {
		...
		if strings.EqualFold(apiClient.Describe().NodeType, "Mieru") {
			controllerService = mieruservice.New(apiClient, controllerConfig)
		} else {
